...
export default function CateringForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Catering Booking Submitted:", formData);
    setSubmitted(true);
  };
      ...
      {submitted ? (
        <div className="bg-white shadow-lg rounded-2xl p-10 w-full max-w-2xl mt-10 mb-10 text-center">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Your catering booking request has been received successfully! <br />
            Our team will contact you soon to plan your perfect Domino’s event. 🍕🎈
          </p>
        </div>
      ) : (
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl mt-10 mb-10">
          <h2 className="text-2xl font-bold text-red-600 mb-6 text-center">
            Domino’s Catering Booking Form
          </h2>
          <p className="text-center text-gray-600 mb-8">
            Fill in your details or contact your nearest Domino’s manager at{" "}
            <span className="font-semibold text-black">1800-208-1234</span>.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            {[
              ...
              { label: "Event Type", name: "eventType", type: "text", placeholder: "Wedding / Corporate / Other" },
          ...
          <p className="text-sm text-left text-gray-600 mt-6">
            We will contact you within 2 working days. Domino's conducts catering for weddings and corporate events at select restaurants and venues. T&C Apply.
          </p>
        </div>
      )}
    </div>
